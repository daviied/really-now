...
@TeleOp
public class Beta_comp_dont_use extends OpMode {
    DcMotor front_left;
    DcMotor front_right;
    DcMotor back_left;
    DcMotor back_right;
    ...
    public void loop() {
        ...
        boolean cancel = gamepad1.right_bumper;
...
if (!flag) {
    ...
    front_left.setPower(((speed - steering) - strafe) / 4);
    front_right.setPower(((speed + steering) + strafe) / 4);
    back_left.setPower(((speed - steering) + strafe) /4);
    back_right.setPower(((speed + steering) - strafe) / 4);
